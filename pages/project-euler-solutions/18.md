---
date: 2018-03-09 10:44:05
title: Project Euler Problem 18 Solution
excerpt: This page presents solutions to Project Euler Problem 18 in Haskell, Python, Ruby and Rust.
comments: true
math: true
---
...
```bash
$ rustc -C target-cpu=native -C opt-level=3 -o pathfinder pathfinder.rs
$ time ./pathfinder
real   0m0.001s
user   0m0.000s
sys    0m0.001s
