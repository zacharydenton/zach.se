...
// Front page art.
//  - WebGPU browsers  -> the full-bleed fractal-flame hero (/flame/hero.js, an
//    ES module; this file stays ES5 because assets/*.js is minified by classic
//    uglifyjs, which can't parse the module's dynamic import()).
//  - Low-power / non-WebGPU devices (phones, Firefox, Safari<18) -> the original
//    composition below (drifting lines + circles + a small WebGL fractal disc),
//    UNCHANGED. hero.js also calls window.__flameFallback() if it has no usable
//    GPU or the engine bails, so those devices land here too.
(function () {
